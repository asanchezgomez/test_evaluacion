from exam.models import Question, Category, Survey, Response, AnswerText, AnswerRadio, AnswerSelect, AnswerInteger, AnswerSelectMultiple
...
class ResponseAdmin(admin.ModelAdmin):
	list_display = ('interview_uuid', 'name', 'created') 
